...
# external-deps
LIBPNG_PATH := $(call my-dir)/../../../../external-deps/png/lib/android/arm
...
LOCAL_CFLAGS    := -D__ANDROID__ -DGP_USE_SOCIAL -Wno-psabi -I"../../../../external-deps/lua/include" -I"../../../../external-deps/bullet/include" -I"../../../../external-deps/png/include" -I"../../../../external-deps/oggvorbis/include" -I"../../../../external-deps/openal/include" -I"../../../../gameplay/src"
